...
const GameSquares: Array<Omit<BingoSquare, 'marked'>> = [
  ...
  },
  {
    ...
    description: 'The protagonist wears a distinctive knitted jumper or wool sweater.',
    category: 'visual',
  },
  {
    id: 'IHsvzBR842',
    title: 'Small Town Secrets',
    description: 'A seemingly peaceful small town turns out to be hiding dark secrets.',
    category: 'mainPlot',
  },
  {
    id: 'my6wERZ2l8',
    title: 'Broken Family Life',
    description: "The investigator's marriage or family relationships are falling apart.",
    category: 'subPlot',
  },
  {
    id: 'yUf43EhafQ',
    title: 'The Murder Board',
    description: 'A notice board with photos, threads, and notes connecting the victims.',
    category: 'visual',
  },
  {
    id: 'pFPv0IvV7V',
  ...
  },
  {
    ...
    description: "An empty whisky bottle or beer cans signal the detective's problems.",
    category: 'visual',
  },
  {
    id: 'k6dz1PtfhX',
  ...
  },
  {
    ...
    description: 'The perfect Scandinavian welfare state hides dark truths.',
    category: 'mainPlot',
  },
  {
    id: 'SFUTJmP6Bc',
  ...
  },
  {
    ...
    description: 'The press puts pressure on the police and complicates the investigation.',
    category: 'subPlot',
  },
  {
    id: 'mLwrI3Evox',
  ...
  },
  {
    ...
    description: 'Danish-Swedish, Norwegian-Swedish, or other transnational police cooperation.',
    category: 'mainPlot',
  },
  {
    id: 'hJ9yAtjexv',
  ...
  },
  {
    ...
    description: 'The series comments on social issues such as poverty or inequality.',
    category: 'mainPlot',
  },
  {
    id: 'b5KAmzdEku',
  ...
  },
  {
    ...
    description: 'A character with piercings, tattoos, and an alternative look is a key person.',
    category: 'character',
  },
  {
    id: 'xhsVI5STqR',
    title: 'The Lisbeth Salander Type',
    description: 'A socially awkward but brilliant female hacker or outsider.',
    category: 'character',
  },
  {
    id: '7wcZkVg22J',
  ...
  },
  {
    ...
    description: 'An important conversation or revelation takes place in a graveyard.',
    category: 'visual',
  },
  {
    id: 'MnFZnaOnOa',
  ...
  },
  {
    ...
    description: 'Scenes from the worn police office with coffee and paperwork.',
    category: 'visual',
  },
  {
    id: 'k3t7uPhnaf',
  ...
  },
  {
    ...
    description: 'A character suffers from depression, PTSD, or another mental illness.',
    category: 'character',
  },
  {
    id: 'XWjsM3x4Xo',
  ...
  },
  {
    ...
    description: 'The action takes place at a national border with jurisdictional issues.',
    category: 'mainPlot',
  },
  {
    id: 'alN5DvjysG',
  ...
  },
  {
    ...
    description: 'An important scene takes place in a deserted factory or industrial building.',
    category: 'visual',
  },
  {
    id: 'qUhN8Nx91l',
    title: 'Ritualistic Murder',
    description: 'The murderer leaves symbols or arranges the bodies ritualistically.',
    category: 'mainPlot',
  },
  {
    id: 'oFYqzBSmYG',
    title: 'The Rookie Officer',
    description: "A young, idealistic officer challenges the experienced detective's methods.",
    category: 'character',
  },
  {
    id: 'tw9gHHt8MI',
  ...
  },
  {
    ...
    description: 'The case involves environmental crime or a corrupt corporation.',
    category: 'mainPlot',
  },
  {
    id: 'I1UXPTB69f',
  ...
  },
  {
    id: '6eo7nXNih1',
    title: 'Cybercrime',
    description: 'The case involves hacking, the dark web, or digital crime.',
    category: 'mainPlot',
  },
  {
    id: 'KkCAXwB0Uj',
  ...
  },
  {
    ...
    description: "The case leads to a children's home, hospital, or care home with a dark past.",
    category: 'mainPlot',
  },
];
